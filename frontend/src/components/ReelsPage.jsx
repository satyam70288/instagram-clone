...
const uploadReels=()=>{}
  return (
    ...
    >
      <div className="flex flex-col items-center justify-center absolute top-10 right-20 ">
        <MonitorUp onClick={uploadReels} size={48} className="text-white" />
        <h1 className="text-white ">Upload Reels</h1>
      </div>
      {/* Down Arrow Button */ }
  <ArrowDownToLine
    size={36}
  ...
  <div className="flex items-center justify-center w-full py-10">
    <div className="relative w-[30vw] h-[90vh] flex items-center justify-center bg-zinc-900 rounded-lg overflow-hidden shadow-lg">
